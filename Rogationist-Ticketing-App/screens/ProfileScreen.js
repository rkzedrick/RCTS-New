...
const styles = StyleSheet.create({
  ...
  title: { marginTop: 120, fontSize: 28, fontWeight: '700', color: '#333', marginVertical: 20 },
  profileContainer: {
    width: '90%',
    padding: 20, // Add padding inside the profile container
    backgroundColor: '#fff',
    borderRadius: 15,
    shadowColor: '#000',
  ...
  profileRow: {
    ...
    paddingVertical: 14, // Increase padding for each row
    paddingHorizontal: 5, // Add horizontal padding for a more spacious feel
    borderBottomWidth: 1,
  ...
  modalContent: { 
    width: '85%', 
    padding: 25, // Increase padding in modal for better spacing
    backgroundColor: '#fff', 
    borderRadius: 10 
  },
  ...
  input: { 
    borderWidth: 1, 
    borderColor: '#ddd', 
    padding: 12, // Increase padding in the input fields
    borderRadius: 8, 
    marginVertical: 10, // Add more vertical margin between inputs
    fontSize: 16 
  },
